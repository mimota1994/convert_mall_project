package com.mimota.controller.backend;

import com.google.common.collect.Maps;
import com.mimota.pojo.Product;
import com.mimota.pojo.User;
import com.mimota.service.IFileService;
...
public class ProductManageController {
    ...
    public ServerResponse setSaleStatus(HttpSession session, String productId,Integer status){
        User user = (User)session.getAttribute(Const.CURRENT_USER);
        if(user == null){
            return ServerResponse.createByErrorCodeMessage(ResponseCode.NEED_LOGIN.getCode(),"用户未登录,请登录管理员");
